...
```
Во первых, нужно сохранить в программе клавишами ctr+S далее указать в какой фаил мы заноси сохранения комадой git add а уже после,git commit с коментарием.
